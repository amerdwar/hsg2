...
XBT_LOG_NEW_DEFAULT_CATEGORY(FairScheduler, "Messages specific for this example");
...
if (allr->type==allocate_type::reduce_all && YarnSchedulerBase::type==sch_type::fifo){
