...
XBT_LOG_NEW_DEFAULT_CATEGORY(fifoScheduler, "Messages specific for this example");
...
if (allr->type==allocate_type::reduce_all ){
	...
	XBT_INFO("add req fifo %s   %d, %d ",allr->requester.c_str(),allr->type,allr->dir->Files->size());
